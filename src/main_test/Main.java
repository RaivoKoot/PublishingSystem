...
import controllers.DataAccessController;
...
public class Main {
	public static void main(String[] args)
	{
		...
		DataAccessController test = new DataAccessController();
		try
		{
			test.test();
			System.out.println("User exists with email " + user.getEmail() + ": " + test.userExists(user));
